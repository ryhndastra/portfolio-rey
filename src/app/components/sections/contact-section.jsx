          ...
          <div className="bg-[#0a0a0a] border-4 border-white p-8 md:p-12 shadow-[12px_12px_0px_0px_#22c55e] relative">
            ...
            <div className="text-center space-y-10">
              <p className="max-w-2xl mx-auto text-gray-300 leading-relaxed font-bold border-l-4 border-[#222] pl-4 md:border-none md:pl-0">
                ...
                full-time opportunities. If you have a concept that needs to be
                compiled into reality, execute the command below.
              </p>

              {/* CTA BUTTON */}
              <a
                href="mailto:ryhndastra@gmail.com"
              ...
              <div className="pt-8 border-t-4 border-[#1a1a1a]">
                <p className="text-xs text-gray-600 font-bold uppercase mb-6 tracking-widest">
                  OTHER_COMM_CHANNELS:
                </p>
                  ...
                  {[
                    {
                      name: "GITHUB_REPO",
                      icon: Github,
                      url: "https://github.com/ryhndastra",
                    },
                    {
                      name: "LINKEDIN_PROFILE",
                      icon: Linkedin,
                      url: "https://www.linkedin.com/in/reyhand-astra",
                    },
                  ].map((social, i) => (
                    <a
                      key={i}
