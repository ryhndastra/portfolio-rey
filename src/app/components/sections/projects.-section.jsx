...
const projects = [
  ...
  },
  {
    ...
    description:
      "Cross-platform mobile application designed for seamless property booking. Integrates cloud-based calendar sync and push notifications.",
  ...
  // },
  {
    ...
    description:
      "Centralized dashboard for game server players. Provides account management, server status monitoring, and news aggregation.",
